            ...
            <div class="row">
                <div class="col-12 col-lg-8 col-xl-9">
                    <div v-bind:class="cardainerStyleClass">
                        <cmp-card v-for="(book, index) in books.slice(0, 6)" v-bind:key="index" v-bind:book="book"></cmp-card>
                    </div>
                    <button class="btn btn-block btn-outline-primary" type="button"><font-awesome-icon icon="arrow-alt-circle-down" class="mr-2"></font-awesome-icon>Load more books...</button>
                </div>
