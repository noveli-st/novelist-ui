                    ...
                    <ul class="list-group list-group-flush rounded overflow-hidden">
                        <li v-for="book in books" v-bind:key="book.index"
                            ...
                            <div class="mx-n2 d-md-flex">
                                ...
                                <router-link v-bind:to="`/reader/${book.id}/`" class="btn btn-sm btn-link" v-b-tooltip.hover.focus title="Reader page"><font-awesome-icon icon="book-open"></font-awesome-icon></router-link>
