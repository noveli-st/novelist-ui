                    ...
                    <ul class="list-group list-group-flush rounded overflow-hidden">
                        <li v-for="book in books" v-bind:key="book.index"
                            ...
                            <div class="mx-n2 d-md-flex">
                                ...
                                <router-link v-bind:to="`/book/${book.id}/edit/settings`" class="btn btn-sm btn-link mr-1" v-b-tooltip.hover.focus title="Book setting"><font-awesome-icon icon="cog"></font-awesome-icon></router-link>
